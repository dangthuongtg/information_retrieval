...
def inference_on_single_labelled_image_pca(query_img_file, 
    ...
    # Query fts
    query_fts =  get_query_embedding(model, device, query_img_file).detach().cpu().numpy() #401408
    query_fts = perform_pca_on_single_vector(query_fts) #4096
...
if __name__ == '__main__':
    # map = measure_performance(labels_dir="./data/oxbuild/gt_files/", img_dir="./data/oxbuild/images/", img_fts_dir="./fts_pca/oxbuild/", weights_file="./weights/oxbuild_final.pth")
    
    
    # map = inference_on_single_labelled_image_pca(query_img_file="./data/oxbuild/images/all_souls_000013.jpg", 
    #                                         labels_dir="./data/oxbuild/gt_files/", 
    #                                         img_dir="./data/oxbuild/images/",
    #                                         img_fts_dir="./fts_pca/oxbuild/",
    #                                         top_k=500,
    #                                         plot=True,
    #                                         weights_file="./weights/oxbuild_final.pth")
    # print(f"Average precision: {map}")
    
    map = inference_on_single_labelled_image_pca(query_img_file="./data/paris/images/paris_defense_000605.jpg", 
                                            labels_dir="./data/paris/gt_files/", 
                                            img_dir="./data/paris/images/",
                                            img_fts_dir="./fts_pca/paris/",
                                            top_k=500,
                                            plot=True,
                                            weights_file="./weights/paris_final.pth")
    print(f"Average precision: {map}")